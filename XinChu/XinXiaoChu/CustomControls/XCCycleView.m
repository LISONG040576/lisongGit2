...
#import "XCCycleView.h"

@interface XCCycleView (){
    NSTimer *_timer;
}
...
@implementation XCCycleView

//用代码创建VCyclePicPlayer时，调用init(初始化),但是不走init函数。
...
- (void) displayUI{
    ...
    [_pageControl setCurrentPageIndicatorTintColor:_dotColor];
...
- (void)handleTap:(UITapGestureRecognizer *)tap {
    ...
    if ([_delegate respondsToSelector:@selector(didSelectedCycleView:atIndex:)]) {
        [_delegate didSelectedCycleView:self atIndex:_curPage];
    }
}
